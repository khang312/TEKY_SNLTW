...
def login():
    ...
    if ten and ngaysinh and country and gender != 'none':
        ...
        with open('survey_responses.txt', 'a') as file:
            response = f"Name: {ten}, Date of Birth: {ngaysinh}, Country: {country}, Gender: {gender}\n"
            file.write(response)

        # Show corresponding image based on the country
        if country == 'Thailand':
        ...
        messagebox.showerror('Error', 'Please complete the survey.')

...
def new_window():
    ...
    btn1_new = tkinter.Button(new_window, command= login, text = 'register')
    btn2= tkinter.Button(new_window, command= quit, text = 'Quit')

    name1 = tkinter.Entry(new_window)
    date2 = tkinter.Entry(new_window)

    quoc_tich1 = ttk.Combobox(new_window)
    quoc_tich1['value'] = ('Vietnam',  'China',  'Thailand')
    name1_new = tkinter.Label(new_window, text= 'Ho va Ten')
    date2_new = tkinter.Label(new_window, text= 'Ngay Sinh')
    quoc_tich1_new= tkinter.Label(new_window, text= 'Quoc Tich')
    quoc_tich1_new.current(0)
    image_china_new = PhotoImage(file=r"/Users/mac/Desktop/TEKY_SNLTW/day7/china.png")
    image_vn_new = PhotoImage(file=r'/Users/mac/Desktop/TEKY_SNLTW/day7/name.png')
    image_thai_new = PhotoImage(file=r'/Users/mac/Desktop/TEKY_SNLTW/day7/thai.png')

    gender_var_new = tkinter.StringVar(value = 'none')
    ...
    date2.place(x=150,y=100)
    date2_new.place(x=50,y=100)

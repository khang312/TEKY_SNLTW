...
def new_window():
    ...
    btn = tkinter.Button(new_window, command= login, text = 'register')
    btn2 = tkinter.Button(new_window, command= quit, text = 'Quit')

    name = tkinter.Entry(new_window)
    date = tkinter.Entry(new_window)

    quoc_tich = ttk.Combobox(new_window)
    quoc_tich['value'] = ('Vietnam',  'China',  'Thailand')
    name1 = tkinter.Label(new_window, text= 'Ho va Ten')
    date1 = tkinter.Label(new_window, text= 'Ngay Sinh')
    quoc_tich1= tkinter.Label(new_window, text= 'Quoc Tich')
    quoc_tich.current(0)
    ...
    radio_female =tkinter.Radiobutton(new_window, text = 'nữ', variable= gender_var, value= 'female')
    radio_male =tkinter.Radiobutton(new_window, text = 'nam', variable= gender_var, value= 'male')
